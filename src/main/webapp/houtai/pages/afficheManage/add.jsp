            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" name="addTable2">
                <tr>
                    ...
                    <td style="color:#90c8e8;"><img src="../../images/icon_card.gif" width="16" height="16" align="absmiddle">&nbsp;&nbsp;
                        <strong>soda公告管理 &nbsp;&nbsp;》》》	添加soda公告</strong></td>
                </tr>
            </table></td>
    </tr>
    <tr>
        <td height="100%" valign="top">
            <div style="overflow:auto;height:100%; width:100%">
                <form action="/houtai/pages/afficheManage/add" id="form01" method="post" name="ggaddform" >
                    <table width="100%" border="0" cellpadding="3" cellspacing="1" class="table1" name="addTable3">
                        <tr>
                            <td style="text-align:right" >标题</td>
                            <td><input type="text" name="neTitle" style="width:400px"><span id="sp01" style="color: red"></span>
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align:right" >作者</td>
                            <td><input type="text" name="uname" value="asa" style="width:400px"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><textarea rows="15" cols="60" name="neContent"></textarea><span id="sp02" style="color: red"></span></td>
                        </tr>
                        <tr>
