    <%@ page contentType="text/html;charset=UTF-8" language="java" %>
        ...
        <td style="color:#90c8e8;"><img src="../../images/icon_card.gif" width="16" height="16" align="absmiddle">&nbsp;&nbsp;<strong>修改菜单信息</strong></td>
        ...
        <TD class="BGCgray"><input type="text" value="用户管理" name="mu_name"/></TD>
        </TR>
        <TR>
        ...
        <TD class="BGCgray"><input type="text" value="user.do" name="mu_url"/></TD>
        </TR>
        <TR>
