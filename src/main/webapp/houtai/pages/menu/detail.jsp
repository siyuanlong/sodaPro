    <%@ page contentType="text/html;charset=UTF-8" language="java" %>
        ...
        <td style="color:#90c8e8;"><img src="../../images/icon_card.gif" width="16" height="16" align="absmiddle">&nbsp;&nbsp;<strong>菜单详情</strong></td>
        ...
        <a href="#" class="barBtn" name="flush"><img src="../../images/btn_refresh.gif" align="absmiddle" name="cddetailflush"> 刷新</a>
        </td>
        </tr>
        </table></td>
        </tr>
        ...
        <BUTTON style="HEIGHT:25px" onClick="history.go(-1);" name="back"><img src="../../images/btn_back.gif" width="16" height="16" align="absmiddle"> 返回</BUTTON>
        </div>
        </div>
        </td>
        </tr>
