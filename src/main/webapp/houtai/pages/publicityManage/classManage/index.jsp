    ...
    <td style="height:34px; background-image:url(../../../images/main_header.gif); border-bottom:1px solid #cfd8e0; padding:0px">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" name="listTable2">
        <tr>
          ...
          <td style="color:#90c8e8;"><img src="../../../images/icon_card.gif" width="16" height="16" align="absmiddle">&nbsp;&nbsp;<strong>行业介绍管理</strong></td>
  ...
  <tr>
    <td style="height:30px; background-color:#bddbff; border-bottom:1px solid #cfd8e0;"><table width="100%" border="0" cellpadding="3" cellspacing="1" class="table1" name="listTable3">
      <TR>
        ...
        <td width="20%" class="BGCgray"><input type="text"name="iy_title"  id="textfield"></td>
        <th width="10%" align="center">更新时间</th>
        <td width="20%" class="BGCgray"><input type="text" name="iy_updatetime" id="textfield"></td>
        <th width="10%" align="center">是否推荐</th>
        <td width="20%" class="BGCgray"><select name="iy_state"  id="select2">
          <option>全部</option>
		  <option>是</option>
		  <option>否</option>
        </select></td>
    ...
    <div style="overflow:auto;height:100%; width:100%">
      <table width="100%" border="0" cellpadding="3" cellspacing="1" class="table1" name="listTable4">
        ...
        <TR>
          ...
          <TD align="left"><a href="lookImpl.html" style="color:black;">前端开发</a></TD>
        ...
        <TR>
          ...
          <TD align="left"><a href="lookImpl.html" style="color:black;">ajax异步的优良性</a></TD>
          <TD align="center">2013-12-14 12:34:55</TD>
		 ...
		 <TR>
          ...
          <TD align="left"><a href="lookImpl.html" style="color:black;">MySQL数据库的详细讲解</a></TD>
          <TD align="center">2013-12-14 12:34:55</TD>
