    ...
    <td style="height:34px; background-image:url(../../../images/main_header.gif); border-bottom:1px solid #cfd8e0; padding:0px">
      <table width="100%" border="0" cellspacing="0" cellpadding="0"  name="addTable2">
        <tr>
          ...
          <strong><a href="index.html">行业介绍添加</strong></td>
        </tr>
    </table></td>
  </tr>
  <tr>
    ...
    <form action="index.html" method="post"  name="hyaddform">
      <table width="100%" border="0" cellpadding="3" cellspacing="1" class="table1"  name="addTable3">
        <tr>
            ...
            <td><input type="text" name="iy_title" value=""></td>
        </tr>
        <tr>
        	<td style="text-align:right" style="width:300px">作者</td>
            <td><input type="text" name="iy_userId" ></td>
        </tr>
        <tr>
        	<td style="text-align:right">是否推荐</td>
            <td><input type="radio" name="iy_state" checked="checked">是&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="state">否</td>
        </tr>
        <tr>
        	<td style="text-align:right">内容</td>
            <td><textarea rows="15" cols="42" name="iy_content"></textarea></td>
        </tr>
        <tr>
