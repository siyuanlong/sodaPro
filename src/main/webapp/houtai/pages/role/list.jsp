        ...
        <td style="height:34px; background-image:url(../../images/main_header.gif); border-bottom:1px solid #cfd8e0; padding:0px">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" name="listTable2">
                <tr>
                    ...
                    <td style="color:#90c8e8;"><img src="../../images/icon_card.gif" width="16" height="16" align="absmiddle">&nbsp;&nbsp;<strong>角色管理</strong></td>
    ...
    <tr>
        <td style="height:30px; background-color:#bddbff; border-bottom:1px solid #cfd8e0;"><table width="100%" border="0" cellpadding="3" cellspacing="1" class="table1" name="listTable3">
            <TR>
                ...
                <td width="20%" class="BGCgray"><input type="text" name="ro_name"  id="textfield"></td>
                <th width="10%" align="center"><STRONG>状态</STRONG></th>
                <td width="20%" class="BGCgray"><select name="ro_state" id="select2">
                    <option>全部</option>
                    <option>启用</option>
                    <option>禁用</option>
                </select></td>
